...
function LinearAlgebra.mul!(
        w::InnerProductVec{F}, v::InnerProductVec{F},
        a::Number
    ) where {F}
    mul!(w.vec, v.vec, a)
    return w
...
function LinearAlgebra.axpby!(
        a::Number, v::InnerProductVec{F}, b,
        w::InnerProductVec{F}
    ) where {F}
...
function VectorInterface.add(
        v::InnerProductVec{F}, w::InnerProductVec{F}, a::Number,
        b::Number
    ) where {F}
